...
$sql = "SELECT * FROM escalas_louvornoite ORDER BY id DESC LIMIT 1";
...
function salvarEscalaNoBanco(escalaData, blobPdf, callback) {
    ...
    formData.append('acao', 'salvar_escalalouvornoite');
    ...
    fetch('salvar_escalalouvornoite.php', {
        method: 'POST',
        body: formData
    })
...
function validarEscala() {
  ...
  fetch('validar_escalalouvornoite.php', {
    method: 'POST',
