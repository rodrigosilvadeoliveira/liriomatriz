...
<br><br>
    <h2 class="mb-4">Consulta de Escalas Criativo</h2>
...
<div class="modal fade" id="modalImagem" tabindex="-1" aria-labelledby="modalImagemLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a id="downloadImagem" href="#" class="btn btn-success" download="escala.png">Download</a>
    ...
    // Abrir modal com nova imagem da escala
    $(".btn-visualizar").click(function(e){
        e.stopPropagation();
        let escalaId = $(this).data('id');

        // Gera uma nova imagem da escala via PHP
        $.get("gerar_imagem_escala.php", {id: escalaId}, function(novaImagem){
            // Atualiza a prévia e o botão de download
            $("#imagemEscala").attr('src', novaImagem);
            $("#downloadImagem").attr('href', novaImagem);
        ...
        $(".btn-excluir").click(function(e){
            ...
            if(confirm("Tem certeza que deseja excluir esta escala?")){
                $.post("excluir_escalacriativo.php", {id:id}, function(resposta){
                    if(resposta.trim() === "ok"){
