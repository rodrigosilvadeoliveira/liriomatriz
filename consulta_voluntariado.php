                    ...
                    <div class="col-12">
                        <div class="card card-dashboard">
                            <div class="card-header bg-white py-3">
                                <h5 class="card-title mb-0"><i class="fas fa-sliders-h me-2"></i>Detalhamento por Função/Instrumento</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <?php 
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="card bg-light">
                                            <div class="card-body p-3">
                                                <h6 class="card-title"><?php echo $instrumentLabels[$instrumento]; ?></h6>
                                                <p class="card-text mb-1">Quantidade: <strong><?php echo $contagemInstrumentos[$instrumento]; ?></strong></p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form id="filtroMusicos" method="GET" action="" class="mb-3">
                                ...
                                <div class="d-flex">
                                    <select name="filtro" id="filtro" class="form-select me-2" onchange="document.getElementById('filtroMusicos').submit()">
                                        <option value="" disabled selected>-- Selecione um filtro --</option>    
                                        <option value="todos" <?php if(isset($_GET['filtro']) && $_GET['filtro']=="todos") echo "selected"; ?>>Todos músicos</option>
                        ...
                        <div class="col-md-6">
                            <form method="GET" action="" class="search-form">
                                ...
                                <div class="search-container">
                                    ...
                                    <input type="text" class="form-control search-input" name="search" placeholder="Pesquisar por nome..." value="<?php echo isset($_GET['search']) ? $_GET['search'] : ''; ?>">
                                </div>
                            </form>
                        </div>
                    </div>
