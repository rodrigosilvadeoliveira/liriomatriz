...
$tabelas_escalas = [
    'escalas_staff' => 'Escala Kids'
];

// Processar parâmetro de tabela selecionada
$tabela_selecionada = $_GET['tabela'] ?? 'escalas_staff';
if (!array_key_exists($tabela_selecionada, $tabelas_escalas)) {
    $tabela_selecionada = 'escalas_staff';
}
