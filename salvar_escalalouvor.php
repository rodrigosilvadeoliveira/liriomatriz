...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalalouvor') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_louvor WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_louvor (nome, descricao, dados_escala, pdf_path, data_criacao) 
