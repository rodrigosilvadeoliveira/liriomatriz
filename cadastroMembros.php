...
<a id="incluirCadastro" value="Novo Volutario" href="loginmembro.php">Alterar Cadastro</a>
...
<form method="POST" action="salvar_membro.php" enctype="multipart/form-data" class="row g-3">
  ...
  <input type="hidden" id="lider" name="lider" value="não">
...
<br>
  ...
  <div class="col-md-3">
    <label for="responsavel" class="form-label">Responsável do menor de idade:</label>
