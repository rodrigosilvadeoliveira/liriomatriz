...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalahomens') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_homens WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_homens (nome, descricao, dados_escala, pdf_path, data_criacao) 
