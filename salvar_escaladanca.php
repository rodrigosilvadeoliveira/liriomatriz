...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escaladanca') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_danca WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_danca (nome, descricao, dados_escala, pdf_path, data_criacao) 
