...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalastaff') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_staff WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_staff (nome, descricao, dados_escala, pdf_path, data_criacao) 
