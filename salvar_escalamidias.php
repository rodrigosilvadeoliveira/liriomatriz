...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalamidias') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_midias WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_midias (nome, descricao, dados_escala, pdf_path, data_criacao) 
