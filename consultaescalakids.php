...
$sql = "SELECT id, nome, pdf_path FROM escalas_kids ORDER BY id DESC";
...
function voltar() {
    ...
    <h2 class="mb-4">Consulta de Escalas Kids</h2>
    ...
    $(document).ready(function(){
        ...
        $(".escala-nome").click(function(){
            ...
            if(detalhesDiv.is(":visible")){
                ...
                if(detalhesDiv.is(":empty")){
                    ...
                    $.get("carregar_escalakids.php", {id:id}, function(html){
        ...
        $(".btn-excluir").click(function(e){
            ...
            if(confirm("Tem certeza que deseja excluir esta escala?")){
                $.post("excluir_escalakids.php", {id:id}, function(resposta){
                    if(resposta.trim() === "ok"){
