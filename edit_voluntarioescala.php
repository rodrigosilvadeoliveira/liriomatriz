                ...
                <form method="POST" action="atualizar_voluntariado_escala.php" enctype="multipart/form-data"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="danca" id="danca" class="form-control"
                            value="<?php echo htmlspecialchars($voluntario['danca'] ?? ''); ?>">
                    </div>
                    <h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="real_time_kids" id="real_time_kids" class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['real_time_kids'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="real_time_treinamento" id="real_time_treinamento"
                                    class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['real_time_treinamento'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="recap_treinamento" id="recap_treinamento" class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['recap_treinamento'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="real_time_adolescentes" id="real_time_adolescentes"
                                    class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['real_time_adolescentes'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="real_time_homens" id="real_time_homens" class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['real_time_homens'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="real_time_mulheres" id="real_time_mulheres"
                                    class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['real_time_mulheres'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="real_time_jovens" id="real_time_jovens" class="form-control"
                                    value="<?php echo htmlspecialchars($voluntario['real_time_jovens'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                    <h5>
