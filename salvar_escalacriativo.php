...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalacriativo') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_criativo WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_criativo (nome, descricao, dados_escala, pdf_path, data_criacao) 
