...
$sql = "SELECT * FROM escalas_criativo ORDER BY id DESC LIMIT 1";
...
$funcoes = ["Real_Time", "Real_Time_KIds", "Recap", "Real_Time_Treinamento", "Recap_treinamento", "Real_Time_Adolescentes", "Real_Time_Homens", "Real_Time_Mulheres", "Real_Time_Jovens"];
$nomesPorFuncao = [];
