...
<body>
    ...
    <div class="container">
        ...
        <div class="card card-form">
            ...
            <form method="POST" action="salvaralterarsenha.php" class="row g-3">
                <div class="col-md-6">
                    <label for="nome" class="form-label -field">*<?php echo __('nome_completo') ?></label>
                    <input type="text" name="nome" class="form-control"
                        value="<?php echo htmlspecialchars($voluntario['nome']); ?>" readonly>
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control"
                        value="<?php echo htmlspecialchars($voluntario['email']); ?>" readonly>
                </div>
                <div class="col-md-6">
                    <label for="telefone" class="form-label -field">*<?php echo __('telefone') ?></label>
                    <input type="text" name="telefone" id="telefone" class="form-control"
                        value="<?php echo htmlspecialchars($voluntario['telefone']); ?>" readonly>

                </div>
                <div class="col-md-6">
                    <label for="celular" class="form-label -field">Celular</label>
                    <input type="text" name="celular" class="form-control"
                        value="<?php echo htmlspecialchars($voluntario['celular']); ?>" readonly>
                </div>
