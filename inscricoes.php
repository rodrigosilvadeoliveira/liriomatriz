...
<h1 id="titulonapagina">Quando disponivel incrições para cursos, Lirio Play, Mergulhar, Arena, o formulário será disponibilizado aqui.</h1>
...
<div class="produtos-container">
        <table>
            ...
            while ($produtoNoCarrinho = mysqli_fetch_assoc($result)) {
                echo '<iframe id="novocomeco" width="640" height="950" frameborder="0" marginheight="0" marginwidth="0">';
