...
$sql = "SELECT * FROM escalas_staff ORDER BY id DESC LIMIT 1";
...
function salvarEscalaNoBanco(escalaData, blobPdf, callback) {
    ...
    formData.append('acao', 'salvar_escalastaff');
