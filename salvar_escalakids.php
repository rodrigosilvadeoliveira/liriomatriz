...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalakids') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_kids WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_kids (nome, descricao, dados_escala, pdf_path, data_criacao) 
