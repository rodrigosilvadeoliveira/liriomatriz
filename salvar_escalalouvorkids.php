...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['acao']) && $_POST['acao'] === 'salvar_escalalouvorkids') {
    ...
    try {
        ...
        $checkSql = "SELECT id FROM escalas_louvorkids WHERE nome = '$nome'";
        ...
        $sql = "INSERT INTO escalas_louvorkids (nome, descricao, dados_escala, pdf_path, data_criacao) 
