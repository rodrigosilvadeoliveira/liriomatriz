...
$permissoes = [
    ...
    'perfil.php' => ['lider','master','secretaria','midias','consulta', 'ministro'],
    'alterarsenha.php' => ['lider','master','secretaria','midias','consulta', 'ministro'],
    'alterarfoto.php' => ['lider','master','secretaria','midias','consulta', 'ministro'],
    'edit_voluntarioescalaAcesso.php' => ['lider','master'],
