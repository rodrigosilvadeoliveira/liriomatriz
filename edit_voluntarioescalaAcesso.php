        ...
        <div class="card card-form">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="atualizar_voluntariado_escala.php" enctype="multipart/form-data"
                    ...
                    <input type="hidden" name="cadastroadm_id" value="<?php echo $cadastroadm_id; ?>">
                    <input type="hidden" name="igreja_id" 
                    value="<?php echo htmlspecialchars($voluntario['igreja_id']); ?>">
                    ...
                    <div class="collapse" id="staff">
                        <div class="col-md-6">
                            <label for="staff1_manhã" class="form-label -field">Staff 1 Manhã</label>
                            <input type="text" name="staff1_manhã" id="staff1_manhã" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['staff1_manhã'] ?? ''); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="staff2_manhã" class="form-label -field">Staff 2 Manhã</label>
                            <input type="text" name="staff2_manhã" id="staff2_manhã" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['staff2_manhã'] ?? ''); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                            <label for="staff1_noite" class="form-label -field">Staff 1 Noite</label>
                            <input type="text" name="staff1_noite" id="staff1_noite" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['staff1_noite'] ?? ''); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="staff2_noite" class="form-label -field">Staff 2 Noite</label>
                            <input type="text" name="staff2_noite" id="staff2_noite" class="form-control"
                    ...
                    <h5>
                        <a class="text-decoration-none d-block py-2" data-bs-toggle="collapse" href="#recepcao"
                            role="button" aria-expanded="false" aria-controls="som">
                            Voluntários Recepção <i class="fas fa-chevron-down ms-2"></i>
                        </a>
                    </h5>
                    <div class="collapse" id="recepcao">
                        <div class="col-md-6">
                            <label for="porta_1" class="form-label -field">Porta 1</label>
                            <input type="text" name="porta_1" id="porta_1" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['porta_1'] ?? ''); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="balcao" class="form-label -field">Balcão</label>
                            <input type="text" name="balcao" id="balcao" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['balcao'] ?? ''); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="area_externa_1" class="form-label -field">Área Externa 1</label>
                            <input type="text" name="area_externa_1" id="area_externa_1" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['area_externa_1'] ?? ''); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="area_externa_2" class="form-label -field">Área Externa 2</label>
                            <input type="text" name="area_externa_2" id="area_externa_2" class="form-control"
                                value="<?php echo htmlspecialchars($voluntario['area_externa_2'] ?? ''); ?>">
                        </div>
                    </div>
